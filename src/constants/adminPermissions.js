...
export const ADMIN_PERMISSIONS = [
  ...
  { slug: 'psychometric.mou', label: 'School MOU', group: 'Psychometric', route: '/psychometric/mou' },
  { slug: 'elibrary.list', label: 'E-Library', group: 'E-Library', route: '/e-library' },
...
export const API_PERMISSION_MAP = {
  ...
  psychometric: ['psychometric.list', 'psychometric.view', 'psychometric.mou'],
  schoolMous: ['psychometric.mou'],
  adminUsers: ['settings.users'],
  adminRoles: ['settings.roles'],
  activityLogs: ['settings.activity'],
  eLibrary: ['elibrary.list'],
};
