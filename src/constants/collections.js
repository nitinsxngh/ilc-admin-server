...
export const DASHBOARD_COLLECTIONS = {
  ...
  /** Manual / CDA v2 psychometric submissions (rule-based reports) */
  cdaV2Submissions: 'cda_v2_submissions',
  psychometricAnalyticsLogs: 'psychometric_analytics_logs',
  /** Student-portal counsellor bookings (payment + adminBookingId link) */
  counsellorBookings: 'ilc_counsellor_bookings',
  counsellorInvoices: 'ilc_counsellor_invoices',
